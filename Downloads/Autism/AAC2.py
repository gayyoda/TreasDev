#Change from individual modes to combined modes using boolean
#Priorty - Somerset, Gay, Normal
#Overlaping words = ['yes', '']
#imports
...
def menu():
    ...
    while ans.lower() not in options: 
        print('###########################################')
        print('AAC-0.0.4, (c) Alex Healey, TreasDev 2019')
